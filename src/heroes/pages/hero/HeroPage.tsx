...
export const HeroPage = () => {
  ...
  if (superheroData) {
    ...
    averagePower = Math.round((totalPower / 4) * 10);
  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={superheroData && superheroData?.strength * 10}
                    className="h-2"
                  />
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={superheroData && superheroData?.intelligence * 10}
                    className="h-2"
                  />
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={superheroData && superheroData.speed * 10}
                    className="h-2"
                  />
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={superheroData && superheroData?.durability * 10}
                    className="h-2"
                  />
                </CardContent>
              </Card>
